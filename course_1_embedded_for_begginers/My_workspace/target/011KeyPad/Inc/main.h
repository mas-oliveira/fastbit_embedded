...
// Address of used registers
#define RCC_AHB1ENR_ADDR ((uint32_t) 0x40023830)
#define GPIOA_MODER_ADDR ((uint32_t) 0x40020000)
#define GPIOA_PUPDR_ADDR ((uint32_t) 0x4002000C)
#define GPIOA_IDR_ADDR   ((uint32_t) 0x40020010)
#define GPIOA_ODR_ADDR   ((uint32_t) 0x40020014)
...
} GPIOx_MODER_t; // GPIO Port Mode (I/O) Register

typedef union {
	uint32_t REG;

	struct {
		uint32_t PUPDR0  :2; // PIN 0 Pull-up/down Register
		uint32_t PUPDR1  :2; // PIN 1 Pull-up/down Register
		uint32_t PUPDR2  :2; // PIN 2 Pull-up/down Register
		uint32_t PUPDR3  :2; // PIN 3 Pull-up/down Register
		uint32_t PUPDR4  :2; // PIN 4 Pull-up/down Register
		uint32_t PUPDR5  :2; // PIN 5 Pull-up/down Register
		uint32_t PUPDR6  :2; // PIN 6 Pull-up/down Register
		uint32_t PUPDR7  :2; // PIN 7 Pull-up/down Register
		uint32_t PUPDR8  :2; // PIN 8 Pull-up/down Register
		uint32_t PUPDR9  :2; // PIN 9 Pull-up/down Register
		uint32_t PUPDR10 :2; // PIN 10 Pull-up/down Register
		uint32_t PUPDR11 :2; // PIN 11 Pull-up/down Register
		uint32_t PUPDR12 :2; // PIN 12 Pull-up/down Register
		uint32_t PUPDR13 :2; // PIN 13 Pull-up/down Register
		uint32_t PUPDR14 :2; // PIN 14 Pull-up/down Register
		uint32_t PUPDR15 :2; // PIN 15 Pull-up/down Register
	} GPIO_PUPDR_BITS;

} GPIOx_PUPDR_t; // GPIO port pull-up/pull-down enable register
...
} GPIOx_IDR_t; // GPIO Input Data Register
...
} GPIOx_ODR_t; // GPIO Output Data Register
